...
public interface TableRow {
  ...
  /**
   * Retrieves a double value from the <b>TableRow</b>'s specified column. 
   * The column may be specified by either its ID or title.
   *
   * @webref tablerow:method
   ...
   * @see TableRow#setDouble(int, double)
   */
  ...
  /**
   * Stores a <b>double</b> value in the <b>TableRow</b>'s specified column. The column 
   * may be specified by either its ID or title.
   *
   * @webref tablerow:method
