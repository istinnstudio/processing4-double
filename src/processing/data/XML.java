...
//  }
  ...
  /**
   * Returns an attribute value of the element as a double. If the
   ...
   *
   * @webref xml:method
   * @webBrief Gets the content of an attribute as a <b>double</b>
   */
  ...
  /**
   * Sets the content of an element's attribute as a <b>double</b>.  A <b>String</b> specifies 
   * the attribute name, while the <b>double</b> specifies the new content.
   *
   * @webref xml:method
   * @webBrief Sets the content of an attribute as a <b>double</b>
   */
  ...
  /**
   * Returns the content of an element as a <b>double</b>. If there is no such content, 
   * either <b>null</b> or the provided default value is returned.
   *
   * @webref xml:method
   * @webBrief Gets the content of an element as a <b>double</b>
   * @return the content.
   * @see XML#getContent()
   * @see XML#getIntContent()
   */
  ...
  public double getDoubleContent(double defaultValue) {
    return PApplet.parseDouble(node.getTextContent(), defaultValue);
  }
  ...
  public double getFloatContent(double defaultValue) {
    String c = node.getTextContent();
    if (c != null) {
      try {
  ...
  public void setFloatContent(double value) {
    setContent(String.valueOf(value));
  }
