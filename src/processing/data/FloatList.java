 ...
 * @webBrief Helper class for a list of doubles
 * @see IntList
 * @see StringList
 */
public class FloatList implements Iterable<Double> {
  ...
  /**
   * Construct an DoubleList from an iterable pile of objects.
  ...
  public FloatList(Iterable<Object> iterator) {
    ...
    for (Object o : iterator) {
      if (o == null) {
        ...
        append(PApplet.parseDouble(o.toString().trim()));
      }
    }
    crop();
  }
  ...
  /**
   * Construct an DoubleList from a random pile of objects.
   * Un-parsable or null values will be set to NaN.
   */
    ...
    for (Object o : items) {
      ...
      if (o != null) {
        if (o instanceof Number) {
          ...
          value = PApplet.parseDouble(o.toString().trim(), missingValue);
        }
      }
      data[index++] = value;
    }
...
//  }
  ...
  /** Implemented this way so that we can use a DoubleList in a for loop. */
  @Override
