...
//  static final String E2D = PGraphicsDanger2D.class.getName();
   ...
   */
  double MAX_FLOAT = Double.MAX_VALUE;
  /**
   ...
   */
  double MIN_FLOAT = -Double.MAX_VALUE;
   ...
   * @see PConstants#QUARTER_PI
   */
  double HALF_PI = (double) (Math.PI / 2.0);
  double THIRD_PI = (double) (Math.PI / 3.0);
  /**
   *
   ...
   * @see PConstants#HALF_PI
   */
  double QUARTER_PI = (double) (Math.PI / 4.0);
  /**
   *
   ...
   * @see PConstants#QUARTER_PI
   */
  double TWO_PI = (double) (2.0 * Math.PI);
  /**
   *
   ...
   * @see PConstants#QUARTER_PI
   */
  double TAU = (double) (2.0 * Math.PI);

  double DEG_TO_RAD = PI/180.0f;
  double RAD_TO_DEG = 180.0f/PI;
