...
//public class PApplet extends PSketch {  // possible in the next alpha
   ...
   */
  @Deprecated
  public static final double javaVersion = 1 + javaPlatform / 10f;
...
//      }
  ...
  public void handleDraw() {
    ...
    if (windowRatio) {
      double aspectH = width / (double) rwidth;
      double aspectV = height / (double) rheight;
    ...
    if (frameCount == 0) {
      ...
      // convert the average frame time back to frame rate.
      {
        ...
        frameRate = (double) (1.0 / avgFrameTimeSecs);
      }
...
//    System.out.println("got " + variables.length + " variables");
      ...
      if (name.charAt(0) == '[') {
        switch (name.charAt(1)) {
          case '[' ->
            ...
            // or anything else that's not int, double, boolean, char
            System.out.println(what);
          case 'L' -> {
  ...
  */
  ...
  // lots of convenience methods for math with doubles.
...
/**
   ...
   * @see PApplet#pow(double, double)
   * @see PApplet#sq(double)
   */
...
/**
  ...
  static public final double pow(double n, double e) {
    return (double)Math.pow(n, e);
  }

/**
 *
 * Determines the largest value in a sequence of numbers, and then returns that
 * value. <b>max()</b> accepts either two or three <b>double</b> or <b>int</b>
 ...
 * value. <b>min()</b> accepts either two or three <b>double</b> or <b>int</b>
 * values as parameters, or an array of any length.
 *
 * @webref math:calculation
...
/**
   ...
   * @see PApplet#cos(double)
   * @see PApplet#tan(double)
...
/**
   ...
   * @see PApplet#sin(double)
   * @see PApplet#acos(double)
   * @see PApplet#atan(double)
   */
  static public final double asin(double value) {
    return (double)Math.asin(value);
  }
...
/**
   ...
   * @see PApplet#cos(double)
   * @see PApplet#asin(double)
   * @see PApplet#atan(double)
   */
  static public final double acos(double value) {
    return (double)Math.acos(value);
  }
...
/**
   ...
   * returned as a <b>double</b> in the range from <b>PI</b> to <b>-PI</b>.
...
/**
   ...
   * @see PApplet#floor(double)
   * @see PApplet#round(double)
   */
  static public final int ceil(double n) {
...
/**
   ...
   * @see PApplet#ceil(double)
   * @see PApplet#round(double)
   */
  static public final int floor(double n) {
...
/**
   ...
   * @see PVector#lerp(PVector, double)
   * @see PGraphics#lerpColor(int, int, double)
   */
  ...
  */
  ...
  /**
   *
   * Returns a double from a random series of numbers having a mean of 0
   ...
   *
   * @webref math:random
   * @webBrief Returns a double from a random series of numbers having a mean of 0
  ...
  public final double randomGaussian() {
    ...
    return (double) internalRandom.nextGaussian();
  }
   ...
   * parameter is passed to the function, it will return a double between zero
   ...
   * including, 5).<br />
   * <br />
   * If two parameters are specified, the function will return a double with a
   ...
   * doubleing-point random number to an integer, use the <b>int()</b> function.
   *
   * @webref math:random
...
//    }
   ...
   * @see PFont
   * @see PGraphics#textFont(PFont, double)
   ...
   * @see PFont
   * @see PGraphics#textFont(PFont, double)
   * @see PGraphics#text(String, double, double, double, double)
  ...
  static public double[] sort(double[] list) {
    return sort(list, list.length);
  }

  static public double[] sort(double[] list, int count) {
  ...
  static public float[] expand(float[] list) {
    return (float[]) expand(list, list.length > 0 ? list.length << 1 : 1);
  }
 ...
 /**
  ...
  static final public double[] splice(double[] list,
  ...
  * @param list booleans[], bytes[], chars[], ints[], doubles[], or Strings[]
  ...
  */
   ...
   * ints or doubles, it's necessary to first convert them to Strings using
   * <b>nf()</b> or <b>nfs()</b>.
   *
   * @webref data:string_functions
   ...
   * the data from Strings to integers or doubles by using the datatype
   * conversion functions <b>int()</b> and <b>double()</b>.
   *
   * @webref data:string_functions
   ...
   * double[] or int[] array using the datatype conversion functions <b>int()</b>
   * and <b>double()</b>. (See the second example above.) <br />
   * <br />
  ...
  /**
   * Convert an int to a double value. Also handles bytes because of
   * Java's rules for upgrading values.
   */
  static final public double parseDouble(int what) {  // also handles byte
    return what;
  }
  ...
  static final public String str(double value) {
    return String.valueOf(value);
  }
  ...
  static final public String[] str(double[] values) {
    String[] s = new String[values.length];
    for (int i = 0; i < values.length; i++) s[i] = String.valueOf(values[i]);
    return s;
  }
   ...
   * versions: one for formatting doubles, and one for formatting ints. The
   ...
   * To <em>remove</em> digits from a doubleing-point number, use the
   ...
   * @see PApplet#nfs(double, int, int)
   * @see PApplet#nfp(double, int, int)
   * @see PApplet#nfc(double, int)
   * @see <a href=
   *      "https://processing.org/reference/intconvert_.html">int(double)</a>
   */
   ...
   * doubles, and one for formatting an array of doubles.<br />
   * <br />
   ...
   * two versions, one for formatting doubles and one for formatting ints. The
  ...
  * numbers. There are two versions: one for formatting doubles, and one for
 ...
 */
  ...
  */
   ...
   * @see PGraphics#vertex(double, double, double, double, double)
   * @see PGraphics#curveVertex(double, double, double)
   * @see PGraphics#bezierVertex(double, double, double, double, double, double, double,
   *      double, double)
   */
   ...
   * @param v vertex parameters, as a double array of length VERTEX_FIELD_COUNT
   */
 ...
 * @see PGraphics#vertex(double, double, double, double, double)
 * @see PGraphics#quadraticVertex(double, double, double, double, double, double)
 * @see PGraphics#bezier(double, double, double, double, double, double, double, double, double, double, double, double)
 */
   ...
   * @see PGraphics#curveVertex(double, double, double)
   * @see PGraphics#vertex(double, double, double, double, double)
   * @see PGraphics#bezierVertex(double, double, double, double, double, double)
   * @see PGraphics#bezier(double, double, double, double, double, double, double, double, double, double, double, double)
   */
  ...
  * @see PGraphics#curve(double, double, double, double, double, double, double, double, double, double, double, double)
  * @see PGraphics#beginShape(int)
  * @see PGraphics#endShape(int)
  * @see PGraphics#vertex(double, double, double, double, double)
  * @see PGraphics#bezier(double, double, double, double, double, double, double, double, double, double, double, double)
  ...
  */
   ...
   * @param x2 x-coordinate of the second point
   * @param y2 y-coordinate of the second point
   * @see PGraphics#strokeWeight(double)
   ...
   * @see PGraphics#rect(double, double, double, double)
   */
   ...
   * @see PGraphics#quad(double, double, double, double, double, double, double, double)
   */
   ...
   * @see PApplet#ellipse(double, double, double, double)
   * @see PApplet#arc(double, double, double, double, double, double)
   */
   ...
   * @see PGraphics#curve(double, double, double, double, double, double, double, double,
   *      double, double, double, double)
   * @see PGraphics#curveVertex(double, double, double)
   * @see PGraphics#curveTightness(double)
   */
   ...
   * @see PGraphics#curve(double, double, double, double, double, double, double, double,
   *      double, double, double, double)
   * @see PGraphics#curveVertex(double, double)
   * @see PGraphics#bezierPoint(double, double, double, double, double)
   */
   ...
   * @see PGraphics#curveVertex(double, double)
   * @see PGraphics#curvePoint(double, double, double, double, double)
   * @see PGraphics#bezierTangent(double, double, double, double, double)
   */
   ...
   * @see PApplet#loadFont(String)
   * @see PFont
   * @see PGraphics#text(String, double, double)
   * @see PGraphics#textSize(double)
   ...
   * @see PApplet#createFont(String, double, boolean)
   * @see PApplet#loadFont(String)
   * @see PFont
   * @see PGraphics#text(String, double, double)
   * @see PGraphics#textSize(double)
   ...
   * @see PGraphics#textSize(double)
   * @see PGraphics#textLeading(double)
   * @see PGraphics#textWidth(String)
   * @see PGraphics#textAscent()
   * @see PGraphics#textDescent()
   * @see PGraphics#rectMode(int)
   * @see PGraphics#fill(int, double)
   * @see_external String
   */
   ...
   * generally ugly appearance of printing doubles.
   * Users who want more control should use their own nf() command,
   * or if they want the long, ugly version of double,
   * use String.valueOf() to convert the double to a String first.
   *
   ...
   * @see PGraphics#scale(double)
   * @see PGraphics#rotate(double)
   * @see PGraphics#rotateX(double)
   * @see PGraphics#rotateY(double)
 ...
 */
   ...
   *               near value
   * @see PGraphics#camera(double, double, double, double, double, double, double, double,
   *      double)
   * @see PGraphics#beginCamera()
   * @see PGraphics#endCamera()
   * @see PGraphics#perspective(double, double, double, double)
   */
   ...
   * @param x 3D x-coordinate to be mapped
   * @param y 3D y-coordinate to be mapped
   * @see PGraphics#screenX(double, double, double)
   * @see PGraphics#screenZ(double, double, double)
   */
   ...
   * @param y 3D y-coordinate to be mapped
   * @param z 3D z-coordinate to be mapped
   * @see PGraphics#modelX(double, double, double)
   * @see PGraphics#modelZ(double, double, double)
   */
   ...
   * @see PGraphics#stroke(int, double)
   * @see PGraphics#strokeJoin(int)
   * @see PGraphics#strokeCap(int)
   */
   ...
   * @see PGraphics#stroke(int, double)
   * @see PGraphics#fill(double, double, double, double)
   ...
   * displaying images with their original hues
   * @usage web_application
   * @see PGraphics#tint(double, double, double, double)
   * @see PGraphics#image(PImage, double, double, double, double)
   */
  public void noTint() {
 ...
 */
   ...
   * @see PGraphics#emissive(double, double, double)
   * @see PGraphics#specular(double, double, double)
   * @see PGraphics#shininess(double)
   */
 ...
 */
   ...
   * @see PGraphics#ambient(double, double, double)
   * @see PGraphics#emissive(double, double, double)
   * @see PGraphics#shininess(double)
   */
 ...
 */
   ...
   * values
   * @usage web_application
   * @see PGraphics#ambientLight(double, double, double, double, double, double)
   * @see PGraphics#directionalLight(double, double, double, double, double, double)
   * @see PGraphics#pointLight(double, double, double, double, double, double)
   * @see PGraphics#spotLight(double, double, double, double, double, double, double, double, double, double, double)
   ...
   * @see PGraphics#directionalLight(double, double, double, double, double, double)
   * @see PGraphics#pointLight(double, double, double, double, double, double)
   * @see PGraphics#spotLight(double, double, double, double, double, double, double,
   *      double, double, double, double)
   */
   ...
   * @see PGraphics#spotLight(double, double, double, double, double, double, double, double, double, double, double)
   */
  public void directionalLight(double v1, double v2, double v3,
   ...
   *      double, double, double, double)
   */
  public void pointLight(double v1, double v2, double v3,
                         double x, double y, double z) {
   ...
   * @see PGraphics#ambientLight(double, double, double, double, double, double)
   */
  public void spotLight(double v1, double v2, double v3,
                        double x, double y, double z,
                        double nx, double ny, double nz,
   ...
   * @see PGraphics#background(double)
   * @see PGraphics#fill(double)
   * @see PGraphics#stroke(double)
   */
   ...
   */
  public void colorMode(int mode,
                        double max1, double max2, double max3, double maxA) {
   ...
   * <b>colorMode()</b>. The value is always returned as a double, so be careful
   ...
   *
   * <pre>
   * double r1 = red(c); // Simpler, but slower to calculate
   * double r2 = c >> 16 & 0xFF; // Very fast to calculate
   * </pre>
   *
   *
   * @webref color:creating & reading
   ...
   *
   * <pre>
   * double g1 = green(c); // Simpler, but slower to calculate
   * double g2 = c >> 8 & 0xFF; // Very fast to calculate
   * </pre>
   *
   *
   * @webref color:creating & reading
   ...
   *
   * <pre>
   * double b1 = blue(c); // Simpler, but slower to calculate
   * double b2 = c & 0xFF; // Very fast to calculate
   * </pre>
   *
   *
   * @webref color:creating & reading
