...
public class LineStroker  {
  ...
  public void setParameters(int lineWidth, int capStyle, int joinStyle,
                            int miterLimit, PMatrix2D transform) {
    this.m00 = LinePath.DoubleToS15_16(transform.m00);
    this.m01 = LinePath.DoubleToS15_16(transform.m01);
    this.m10 = LinePath.DoubleToS15_16(transform.m10);
    this.m11 = LinePath.DoubleToS15_16(transform.m11);
