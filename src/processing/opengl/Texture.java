...
public class Texture implements PConstants {
  ...
  protected double maxTexcoordU;
  protected double maxTexcoordV;
  ...
  public void init(int width, int height,
    ...
    maxTexcoordU = (double)width / glWidth;
    maxTexcoordV = (double)height / glHeight;
